...
| OPPO OS 16 links | Resolves `https://*.allawnos.com/downloadCheck?...` links and refreshes expired OSS tickets transparently |
...
OPPO/ColorOS 16 `https://*.allawnos.com/downloadCheck?...` URLs are detected
automatically. MUDL sends a
