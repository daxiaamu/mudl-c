...
SRCS = main.c options.c engine.c http.c url.c file_io.c progress.c utils.c segment.c thread_pool.c persist.c checksum.c
OBJS = $(SRCS:.c=.o)
TARGET = mudl.exe
ifeq ($(OS),Windows_NT)
RM = del /Q /F
...
unit-test:
	...
	$(CC) $(CFLAGS) -I. -o tests/test_options.exe tests/test_options.c options.c http.c url.c utils.c -lws2_32 -lsecur32
